...
// NOTE: Memory is controlled via nextflow.config (you set run_scribe to 13 GB there)
...
// ---------------- Process: run_scribe ----------------
// Falls back to Python if Rscript is unavailable
process run_scribe {
    tag "Run SCRIBE"
    publishDir "${params.outdir}/results", mode: 'copy'
    cpus params.threads
    // memory is taken from nextflow.config (withName:run_scribe)
